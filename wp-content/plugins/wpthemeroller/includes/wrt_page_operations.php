...
class wrtPageOperations{
    public function create_plugin_pages($page_title, $page_code, $shortcodes = NULL, $template = 'default') {
        global $wpdb;
        $the_page_name = $the_page_title = $page_title;
        // the menu entry...
    ...
    public function remove_plugin_pages($page_code) {
        global $wpdb;
